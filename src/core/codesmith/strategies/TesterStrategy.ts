...
export class TesterStrategy implements AgentStrategy {
    ...
    private async generateTests(
        ...
        const { MCPServiceShim } = await import('../../shims/mcp-service');
        ...
        const result = await CodeSmithRuntimeUtils.callModel(ctx, agentConfig, config, prompt, policy, isTestSpriteConfigured ? tools : undefined, maxSteps);
