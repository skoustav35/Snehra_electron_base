        ...
        >
          <div
            className={classNames(
              'fixed top-[calc(var(--header-height)+0.95rem)] bottom-[calc(var(--statusbar-height)+0.5rem)] w-[var(--workbench-inner-width)] z-0 transition-[left,width] duration-200 bolt-ease-cubic-bezier',
              {
                ...
                <div className="relative flex-1 overflow-hidden">
                  ...
                  <View initial={{ x: '100%' }} animate={{ x: selectedView === 'preview' ? '0%' : '100%' }}>
                    <div className="absolute inset-0 flex flex-col">
                      ...
                      <div className="flex items-center gap-2 px-3 py-1.5 border-b border-bolt-elements-borderColor bg-bolt-elements-background-depth-2 flex-shrink-0">
                        <span className="text-xs font-medium text-bolt-elements-textSecondary flex items-center gap-1.5">
                          <div className="i-ph:eye-duotone text-accent-500" />
                          Live Preview
                        </span>
                        <div className="ml-auto flex items-center gap-2">
                          ...
                          {activePreview?.baseUrl && (
                            <a
                              ...
                              className="flex items-center gap-1.5 px-2.5 py-1 text-xs rounded-md border border-bolt-elements-borderColor bg-bolt-elements-item-backgroundDefault hover:bg-bolt-elements-item-backgroundHover text-bolt-elements-textSecondary hover:text-bolt-elements-textPrimary transition-colors"
                          ...
                          <button
                            ...
                            disabled={streaming}
                            className="flex items-center gap-1.5 px-2.5 py-1 text-xs rounded-md border border-bolt-elements-borderColor bg-bolt-elements-item-backgroundDefault hover:bg-bolt-elements-item-backgroundHover text-bolt-elements-textSecondary hover:text-bolt-elements-textPrimary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            title="Save project to GitHub repository"
                          >
