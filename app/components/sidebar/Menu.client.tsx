...
export const Menu = ({ openOverride, onOpenOverrideChange }: MenuProps) => {
  ...
  const setOpen = useCallback(
    ...
    [openOverride, onOpenOverrideChange],
  );
  ...
  }, [isSettingsOpen, openOverride, setOpen]);
    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-[var(--snr-glass-bg)] backdrop-blur-xl border-r border-bolt-elements-borderColor',
          'shadow-sm text-sm',
          isSettingsOpen ? 'z-40' : 'z-sidebar',
        )}
      >
        <div className="h-14 flex items-center justify-between px-4 border-b border-bolt-elements-borderColor rounded-tr-2xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-8 h-8 inline-flex items-center justify-center rounded-lg border border-bolt-elements-borderColor bg-bolt-elements-background-depth-2 text-bolt-elements-textSecondary hover:text-bolt-elements-textPrimary hover:bg-bolt-elements-background-depth-3 transition-colors"
            >
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-bolt-elements-item-backgroundActive text-bolt-elements-item-contentAccent hover:bg-bolt-elements-sidebar-buttonBackgroundHover rounded-lg px-4 py-2 transition-colors border border-bolt-elements-borderColor"
              >
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ? 'bg-bolt-elements-button-primary-background text-bolt-elements-button-primary-text border border-bolt-elements-button-primary-border'
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-bolt-elements-background-depth-2 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-bolt-elements-focus border border-bolt-elements-borderColor text-sm text-bolt-elements-textPrimary placeholder:text-bolt-elements-textTertiary"
                type="search"
            ...
            <DialogRoot open={dialogContent !== null}>
              {binDates(filteredList).map(({ category, items }) => (
                <div key={category} className="mt-2 first:mt-0 space-y-1">
                  <div className="text-xs font-medium text-bolt-elements-textSecondary sticky top-0 z-1 bg-[var(--snr-glass-bg)] px-4 py-1 backdrop-blur-xl">
                    {category}
                  </div>
          ...
          <div className="flex items-center justify-between border-t border-bolt-elements-borderColor px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-bolt-elements-textSecondary hidden sm:inline">
                Appearance controls are in settings
              </span>
            </div>
          </div>
        </div>
      ...
      <motion.button
        ...
        animate={{ opacity: open ? 1 : 0, x: open ? 0 : -20, pointerEvents: open ? 'auto' : 'none' }}
        transition={{ duration: 0.2, delay: open ? 0.1 : 0, ease: cubicEasingFn }}
        onClick={() => setOpen(false)}
        className={classNames(
          'fixed top-1/2 -translate-y-1/2 flex items-center justify-center',
          'w-8 h-16 rounded-r-2xl border-y border-r border-b border-bolt-elements-borderColor',
          'bg-[var(--snr-glass-bg)] backdrop-blur-xl shadow-lg',
          'text-bolt-elements-textSecondary hover:text-bolt-elements-textPrimary',
          'hover:bg-bolt-elements-item-backgroundHover hover:w-10 transition-all duration-200 cursor-pointer text-xl',
          isSettingsOpen ? 'z-40' : 'z-sidebar',
        )}
        style={{ left: '340px', borderLeft: 'none' }}
        aria-label="Close sidebar"
      >
