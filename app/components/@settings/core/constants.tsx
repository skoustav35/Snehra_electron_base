...
import { User, Settings, Bell, Star, Database, Cloud, Laptop, Github, Wrench, List, CreditCard } from 'lucide-react';
...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  credits: 'Purchase and manage your execution credits',
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'credits', visible: true, window: 'user' as const, order: 8 },
