        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredProviders.map((provider, index) => (
            <motion.div
              key={provider.name}
              className={classNames(
                'platinum-panel platinum-panel--neutral text-bolt-elements-textPrimary',
            ...
            >
              <div className="absolute top-0 right-0 p-2 flex gap-1">
                {URL_CONFIGURABLE_PROVIDERS.includes(provider.name) && (
                  <motion.span
                    className="platinum-chip platinum-chip--active px-2 py-0.5 text-xs font-medium"
              ...
              <div className="flex items-start gap-4 p-4">
                <motion.div
                  className={classNames(
                    ...
                    'platinum-subpanel group-hover:bg-bolt-elements-surface-platinumHover',
                    'transition-all duration-200',
                    ...
                    >
                      <div className="flex items-center gap-2 mt-4">
                        {editingProvider === provider.name ? (
                          ...
                          <div
                            className="platinum-subpanel flex-1 cursor-pointer px-3 py-2 text-sm group/url"
              ...
              <motion.div
                ...
                animate={{
                  borderColor: provider.settings.enabled ? 'rgba(56, 180, 255, 0.2)' : 'rgba(56, 180, 255, 0)',
