      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <div className="platinum-subpanel flex h-12 w-12 items-center justify-center rounded-xl ring-1 ring-bolt-elements-borderColorActive">
              <Cpu className="w-6 h-6 text-bolt-elements-item-contentAccent" />
            </div>
            <div>
                ...
                <Card className="mt-4">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <PackageOpen className="w-5 h-5 text-bolt-elements-item-contentAccent" />
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-bolt-elements-textSecondary mb-4">
                          ...
                          <a
                            ...
                            className="inline-flex items-center gap-1 text-bolt-elements-item-contentAccent hover:underline"
                          >
                            ollama.com/library
