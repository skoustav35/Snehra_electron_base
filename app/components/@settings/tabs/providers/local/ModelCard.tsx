...
function ModelCard({ model, onUpdate, onDelete }: ModelCardProps) {
  return (
    <Card className="transition-all duration-200 hover:border-bolt-elements-borderColorActive hover:bg-bolt-elements-surface-platinumHover">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={classNames(
                'platinum-action px-3 py-2 text-xs transition-all duration-200',
                'text-bolt-elements-item-contentAccent hover:border-bolt-elements-borderColorActive',
            ...
            <button
              ...
              disabled={model.status === 'updating'}
              className={classNames(
                'platinum-action platinum-action--danger px-3 py-2 text-xs transition-all duration-200',
                'disabled:opacity-50 disabled:cursor-not-allowed',
              )}
            >
