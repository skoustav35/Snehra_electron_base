...
function ProviderCard({
  ...
  return (
    <Card className="transition-all duration-300 hover:border-bolt-elements-borderColorActive hover:bg-bolt-elements-surface-platinumHover">
          ...
          <div className="flex items-start gap-4 flex-1">
            <div
              className={classNames(
                ...
                provider.settings.enabled
                  ? 'platinum-subpanel ring-1 ring-bolt-elements-borderColorActive'
                  : 'platinum-subpanel',
              )}
            >
              <Icon
                className={classNames(
                  ...
                  provider.settings.enabled ? 'text-bolt-elements-item-contentAccent' : 'text-bolt-elements-textTertiary',
                )}
              />
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="platinum-chip px-2 py-1 text-xs font-medium">Local</span>
              </div>
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="platinum-input w-full text-sm"
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                    ...
                    <button
                      ...
                      className="platinum-subpanel w-full px-4 py-3 text-left text-sm group transition-all duration-200"
                    >
                      <div className="flex items-center gap-3 text-bolt-elements-textSecondary group-hover:text-bolt-elements-textPrimary">
                        <Link className="w-4 h-4 group-hover:text-bolt-elements-item-contentAccent transition-colors" />
