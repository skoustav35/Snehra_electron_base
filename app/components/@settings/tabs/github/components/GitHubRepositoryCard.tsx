...
interface GitHubRepositoryCardProps {
  ...
  onVfsConnect?: (repo: GitHubRepoInfo) => void;
}

export function GitHubRepositoryCard({ repo, onClone, onVfsConnect }: GitHubRepositoryCardProps) {
  return (
    <a
      key={repo.name}
      href={repo.html_url}
        ...
        <div className="flex items-center justify-between pt-3 mt-auto">
          ...
          {onVfsConnect && (
            <button
              ...
              title="Open directly in Virtual File System"
            >
              <div className="i-ph:folder-open w-3.5 h-3.5" />
              Open VFS
            </button>
          )}
          {onClone && (
